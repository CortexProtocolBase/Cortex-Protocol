...
import { Shield, TrendingDown, Activity, Target, Award, BarChart3 } from "lucide-react";
    ...
    <>
      ...
      <WalletGate>
        <main className="pt-28 pb-20 max-w-5xl mx-auto px-6">
          ...
          {loading ? (
            <div className="animate-pulse h-96 bg-card rounded-2xl" />
          ) : !data ? (
            ...
            <>
              ...
              <div className="bg-card border border-border rounded-2xl p-6 mb-8">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span
                    className={`font-heading text-lg font-bold ${
                      levelColor[data.riskLevel] || "text-muted"
                    }`}
                  >
                    {data.riskLevel.toUpperCase()} ({data.riskScore}/100)
                  </span>
                </div>
                <div className="w-full h-3 bg-card-solid rounded-full overflow-hidden mb-4">
                  <div
                ...
                {data.factors.length > 0 && (
                  <div className="mb-3">
                    <p className="text-xs text-muted mb-2">Risk Factors:</p>
